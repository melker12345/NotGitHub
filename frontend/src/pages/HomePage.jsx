      ...
      <div className="space-y-12">
        ...
        <section className="grid md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 hover:shadow-lg transition-shadow duration-300">
            ...
            <p className="text-gray-600">Create and maintain your code repositories with complete version control and secure access management.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 hover:shadow-lg transition-shadow duration-300">
            ...
            <p className="text-gray-600">Organize your work with powerful issue tracking and project management tools to keep your team on track.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 hover:shadow-lg transition-shadow duration-300">
            ...
            <p className="text-gray-600">Work together with team members using SSH authentication and pull requests for seamless collaboration.</p>
          </div>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-gray-800">Explore Repositories</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {publicRepos.map(repo => (
                <div key={repo.id} className="border border-gray-200 rounded-md p-4 hover:shadow-md transition-shadow">
                  ...
                  <p className="text-gray-600 text-sm mt-1 line-clamp-2">{repo.description || 'No description'}</p>
